...
export function SidebarList() {
  ...
  return (
    <div className="flex flex-col flex-1 m-3 overflow-hidden ">
      ...
      <div className="flex-1 py-2 mt-5 overflow-auto">
        {chats?.length ? (
      ...
      <div className="flex flex-col items-center justify-between px-1 py-4 space-y-3">
        ...
        {/* <Button className="h-12 w-full justify-start px-4 bg-background shadow-none hover:bg-background-secondary rounded-[10px] text-primary-foreground">
          BRZ-Jobs API
        </Button> */}
      </div>
    </div>
